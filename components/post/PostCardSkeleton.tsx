...
export function PostCardSkeleton() {
  return (
    <div className="bg-white rounded-lg border mb-6" style={{ borderColor: 'var(--color-instagram-border)' }}>
      {/* 헤더 영역 (60px) */}
      <div className="flex items-center justify-between px-4 h-[60px] border-b" style={{ borderColor: 'var(--color-instagram-border)' }}>
